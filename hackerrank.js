...
let page;
const mail="yinexa9186@aregods.com";
const password="sneha1234";
...
.then(function(){
    ...
    console.log("All warmup Questions are selected !!!");
})
...
function questionSolver(question, answer){
    return new Promise(function(resolve,reject){
        ...
        linkPromise.then(function(){
            ...
            let typePromise = page.type('.input.text-area.custominput.auto-width',answer);
            return typePromise;
        }).then(function(){
            ...
            return waitAndClick('.lines-content.monaco-editor-background');
